...
typedef enum {
    ...
    RR_WATER_TEMPLE_BOULDER_RIVER,
    RR_WATER_TEMPLE_BOULDERS_ALCOVE,
    ...
    RR_WATER_TEMPLE_MQ_SIDE_TOWER_3F_ROOM,
    RR_WATER_TEMPLE_MQ_SIDE_TOWER_1F_ROOM,
    ...
    RR_WATER_TEMPLE_MQ_LIZALFOS_LOOP,
