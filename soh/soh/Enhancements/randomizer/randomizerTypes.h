...
typedef enum {
    ...
    RR_WATER_TEMPLE_BLOCK_ROOM_TO_BOULDERS,
    RR_WATER_TEMPLE_BLOCK_ROOM,
    RR_WATER_TEMPLE_BLOCK_ROOM_TO_JETS,
    RR_WATER_TEMPLE_JETS_ROOM,
    RR_WATER_TEMPLE_BOULDERS_UPPER,
    RR_WATER_TEMPLE_BOULDERS_UPPER_ALCOVE,
    RR_WATER_TEMPLE_OUTSIDE_BOSS_KEY_ROOM,
    ...
    RR_WATER_TEMPLE_MQ_PILLAR_HIGH,
